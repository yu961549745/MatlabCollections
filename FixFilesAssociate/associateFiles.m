...
% .mlappinstall, .mltbx, .mlpkginstall, .mlprj .mlx
%
% INPUT:
...
fileExtCell = {...
    ...
    % add mlx support 961549745@qq.com 2016/8/4
    % for the unkown part '-58', just set same as the m-file
    'mlx',    'MATLAB Visual Code'         , '-58'                        ,...
    {'Open', 'uiopen(''%1'',1)'}           , {'Run', 'run(''%1'')'}      ; ...
    'mat'   , 'MATLAB Data'                , '-59'                       , ...
